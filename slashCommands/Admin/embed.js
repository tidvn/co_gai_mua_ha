...
module.exports = {
  ...
  options: [ //OPTIONAL OPTIONS, make the array empty / dont add this option if you don't need options!
	//INFORMATIONS! You can add Options, but mind that the NAME MUST BE LOWERCASED! AND NO SPACES!!!, for the CHOCIES you need to add a array of arrays; [ ["",""] , ["",""] ] 
		...
		{"String": { name: "image", description: "img link", required: false }}, 
		{"String": { name: "thumbnail", description: "Thumbnail link", required: false }}, 
  ...
  run: async (client, interaction) => {
    try{
		...
		const EmbedThumbnail = options.getString("thumbnail");
		const EmbedImage = options.getString("image");
		...
		.setThumbnail(String(EmbedThumbnail))
		.setImage(String(EmbedImage))
		.setTimestamp()
